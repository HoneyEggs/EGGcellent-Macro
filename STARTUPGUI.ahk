...
;######################################################################################################################################################################################################
;
Gui, Add, Tab3, x-1 y-3 w915 h505, Selection|Modifications|Credits
;[SELECTION]
Gui, Tab, 1
;{Grind Spins}
; Commons
...
;{Auto-Level}
Gui, Add, Text, x3 y48 vTextElementToLevelUpWith, Element To Level Up With:
...
;[MULTI-TABBED GUI]	
Gui, Add, Button, x1 y19 w302 vButtonGrindSpins1 gegg_ButtonGrindSpins1 Disabled, Grind Spins
Gui, Add, Button, xp+302 y19 w302 vButtonAutoSpin1 gegg_ButtonAutoSpin1, Auto-Spin
Gui, Add, Button, xp+302 y19 w302 vButtonAutoLevel1 gegg_ButtonAutoLevel1, Auto-Level
Gui, Add, Text, x3 y48 vTextElementsToStopAt, Element(s) To Stop At:
Gui, Add, GroupBox, x5 y67 w148 h398 vGroupBoxCommonsAndUncommons, Commons and Uncommons
...
Gui, Add, Text, x3 y67 w2 h399 0x7 vVerticalDivider1
...
Gui, Add, Text, x2 y43 w904 h2 0x7 vHorizontalDivider1
Gui, Add, Text, x3 y65 w902 h2 0x7 vHorizontalDivider2
Gui, Add, Text, xp y464 wp h2 0x7 vHorizontalDivider3
; Secondaries
...
Gui, Submit, Nohide
Gui, Show, w908 h491 Center, EGGcellent Macro v2
;
;######################################################################################################################################################################################################
